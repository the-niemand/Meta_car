    ...
    <div className='flex justify-between gap-5 mx-auto w-[75%] max-lg:flex-col mb-24 relative'>
      ...
      <div className='w-[40%] max-lg:w-full flex flex-col gap-9 relative z-[4]'>
        ...
        <div className='flex flex-col gap-3 relative z-[2]'>
          <span className='flex items-center'> <BsFillTelephoneFill className='mr-2'/>+212 601010101 </span>
          <span className='flex items-center'> <ImMail3 className='mr-2'/> Metacar@gmail.com </span>
          <span className='flex items-center'> <FaMapLocationDot className='mr-2'/> Morocco,Casablanca </span>
        </div>
