...
function ModelCard({ modelImg, modelName, modelComp, modelTrans, modelP, modelDoor, modelFuel, num }) {
  ...
  return (
    <div className='bg-white w-[70%] mx-auto rounded-xl shadow-md'>
      ...
      <div className='p-5 px-6 flex flex-col gap-3'>
        ...
        <span className='flex justify-between'>kilometer<span className='flex gap-1 text-accent'>16000 km</span> </span>
...
function Models() {
  return (
    <div className='relative z-[4]' >
      ...
      <div className='flex items-start justify-center gap-4 w-full max-md:w-[80%] p-12'>

        <Sidebar />
        <div className='pb-20 mx-auto grid grid-cols-3 md-lg:grid-cols-2 max-md:grid-cols-1 gap-12'>
          {carModels.map((model) => {
            return (<ModelCard
              num={model.num}
